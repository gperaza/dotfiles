...
(use-package deft
  ...
  (setq deft-directory "/home/gperaza/Drive/Notes")
  (setq deft-strip-summary-regexp
        (concat "\\("
	        "^:.+:.*\n" ; any line with a :SOMETHING:
	        "\\|^#\\+.*\n" ; anyline starting with a #+
	        "\\|^##.*\n" ; anyline starting with a ##
	        "\\|^\\- tags:.*\n" ; anyline starting with ::tags
...
(use-package ivy-bibtex
  ...
  (setq org-cite-global-bibliography '("/home/gperaza/Drive/Library/bibliography.bib"))
...
(use-package ox-ipynb
    ...
    :config
    (setq ox-ipynb-kernelspecs '((ipython kernelspec
 ...
 (python kernelspec
                 ...
                 (language . "python")
                 (name . "python3"))))
    (setq ox-ipynb-language-infos '((ipython language_info
          (codemirror_mode
           (name . ipython)
           (version . 3))
          (file_extension . ".py")
