...
(use-package solarized-theme
  ...
  (setq solarized-height-minus-1 120)
  (setq solarized-height-plus-1 120)
  (setq solarized-height-plus-2 120)
  (setq solarized-height-plus-3 120)
  (setq solarized-height-plus-4 120)
...
(use-package ivy-bibtex
  ...
  (setq bibtex-completion-bibliography
        '("/home/gperaza/Documents/SortedResources/full-bibliography.bib"))
...
is ~C-c ]~ (default), label link ~C-c (~, and ref link ~C-c )~. TODO This is
not working, I need to manually setup the bindings for the ivy functions.
...
cite link. TODO Or perhaps this is what is breaking things.
...
'((path "https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS_HTML")
 ...
 (tagindent ".8em")
 (tagside "right")))
(setq my-prob-stat-course-dir
      "~/Documents/Teaching/Probability-and-Statistics/course-site/")
(add-to-list
 'org-publish-project-alist
 `("prob-stats-html"
   :base-directory ,my-prob-stat-course-dir
   :base-extension "org"
   :publishing-directory ,my-prob-stat-course-dir
   :recursive nil
   :publishing-function org-html-publish-to-html
   :headline-levels 4
   :html-head "<link rel='stylesheet' href='css/course.css' />\n<link rel='stylesheet' href='http://fonts.googleapis.com/css?family=PT+Sans:400,400italic,700|Abril+Fatface'>"
   :html-preamble ,(concat
       "<h1>Probability and Statistics - UPY - 2017</h1>\n"
       "<a href=\"index.html\"> HOME </a>\n|\n"
...
;;  'org-publish-project-alist
;;  `("prob-stats-static"
;;    :base-directory ,concat my-prob-stat-course-dir
...
(add-to-list
 'org-publish-project-alist
 `("prob-stats-slides"
   :base-directory ,(concat my-prob-stat-course-dir "slides/")
   :base-extension "org"
   :publishing-directory ,(concat my-prob-stat-course-dir "slides/")
   :recursive nil
...
(add-to-list
 'org-publish-project-alist
 `("prob-stats-hw"
   :base-directory ,(concat my-prob-stat-course-dir "homework/")
   :base-extension "org"
   :publishing-directory ,(concat my-prob-stat-course-dir "homework/")
   :recursive nil
   :publishing-function org-html-publish-to-html
   :headline-levels 4
   :html-head "<link rel='stylesheet' href='../css/course.css' />\n<link rel='stylesheet' href='http://fonts.googleapis.com/css?family=PT+Sans:400,400italic,700|Abril+Fatface'>"
...
(add-to-list
 'org-publish-project-alist
 '("prob-stats-course"
   :components ("prob-stats-html" "prob-stats-slides" "prob-stats-hw")))
#+END_SRC
