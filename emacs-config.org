...
Don't ask for confirmation when evaluating a code block. I generally have huge
and slow code blocks, we don't want to evaluate this on export. Also, being huge
better keep them folded at start-up.
...
*** LaTeX fragments
Edit LaTeX fragments like editing src blocks
