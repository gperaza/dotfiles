...
** Ido + smex
Ido and smex are completion engines for emacs. Helm is more powerful
than ido, but also slower and more intrusive. I like ido better, but
will still use some helm dependent packages that are just too good to
let go. Also helm is an org-ref dependency.
